...
public class TicketMasterAPI {
	...
	private static final String API_KEY = "9GHbnx58GlM5qsLgFJIZz4fW0NgatNxM";
	...
	public List<Item> search(double lat, double lon, String keyword) {
		...
		// Convert lat and lon to gethash, since ticketmaster only accepts geohash val
	...
	/**
	 * Main entry for sample TicketMaster API request
	 */
	...
	/**
	 * Helper methods to use entity item
	 */
